...
namespace VotingSystem.Persistence.Migrations
{
    ...
    [Migration("20260819160857_UserElectionTable")]
    partial class UserElectionTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ElectionUsers", b =>
                {
                    ...
                    b.HasKey("ElectionsId", "UsersId");

                    b.HasIndex("UsersId");

                    b.ToTable("ElectionUsers");
                });
            ...
            modelBuilder.Entity("ElectionUsers", b =>
                {
                    b.HasOne("VotingSystem.Domain.Entities.Election", null)
                        .WithMany()
                        .HasForeignKey("ElectionsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("VotingSystem.Domain.Entities.Users", null)
                        .WithMany()
